  ...
  .workslayout
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="three").destitle Q3：圖片可以使用哪些檔案格式和色彩模式？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="four").destitle Q4：同一個作品可以不同的行動裝置上編輯嗎？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="five").destitle Q5：未編輯完成的作品，可以之後繼續編輯嗎？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="six").destitle Q6：編輯時的操作反應很慢？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="seven").destitle Q7：使用手機編輯作品時，為何不能調整相片框位置及大小或增加文字及插圖？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="eight").destitle Q8：我可以分享完成訂購的作品嗎？
    ...
    .d-flex.flex-column
      ...
      .d-flex.labelContent
        ...
        label(for="ten").destitle Q10：「色差」說明？
      .text-justify.indent.pl-3 A：圖片上傳中無法停止上傳，請您耐心等待圖片上傳完成後，再刪除即可。
